...
<p>
  ...
  <div class="code"> build and install via eclipse  </div>
  <div class="code"> git checkout upgrade-branch  </div>
  <div class="code"> build and install via eclipse  </div>
...
<p>
  ...
  <div class="code"> adb uninstall plasma.apk  </div>
  <div class="code"> adb install plasma-oldversion.apk </div>
  <div class="code"> adb install plasma-newversion.apk  </div>
